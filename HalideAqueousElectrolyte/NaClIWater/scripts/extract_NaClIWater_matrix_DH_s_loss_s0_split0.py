#!/usr/bin/env python3
"""Extract NaClIWater split-0 S0 values with matrix DH S-loss fits."""
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=SCRIPT_DIR / "S0_NaClIWater_matrix_DH_s_loss_split0.csv")
