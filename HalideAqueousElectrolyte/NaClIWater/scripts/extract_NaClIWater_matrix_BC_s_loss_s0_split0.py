#!/usr/bin/env python3
"""Extract NaClIWater split-0 S0 values with bare-Coulomb matrix S-loss fits."""
...
import extract_NaClIWater_matrix_DH_s_loss_s0_split0 as dh_common
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=SCRIPT_DIR / "S0_NaClIWater_matrix_BC_s_loss_split0.csv")
